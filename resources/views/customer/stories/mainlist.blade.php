                            ...
                            <table class="table table-striped table-bordered dom-jQuery-events dataTable" id="DataTables" role="grid" aria-describedby="DataTables_Table_0_info">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a class="btn btn-primary text-white tab-order" data-toggle="modal" data-target="#viewvaluestoriesModal{{$item->id}}"  href="#"><i class="icon-pencil"></i> View</a>
                                            <a class="btn btn-warning text-white tab-order" href="{{url('customer/value_stories/list')}}/{{$item->id}}"><i class="icon-list"></i> Sub List</a>
                                            
                                        </td>
                                    </tr>
                                    <div class="modal fade text-left show" id="viewvaluestoriesModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <h3 class="modal-title" id="myModalLabel35">  Value Story Details</h3>
