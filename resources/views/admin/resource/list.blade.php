                                              ...
                                              <div class="modal-body">
                                                    ...
                                                    <fieldset class="form-group floating-label-form-group">
                                                        ...
                                                        <select name="type[]" id="type" class="form-control select2-multi" multiple>
                                                              ...
                                                              <option value="1" @if(in_array(1,explode(',',$item->type))) selected @else @endif>Customer</option>
                                                              <option value="2" @if(in_array(2,explode(',',$item->type))) selected @else @endif>Partner</option>
                                                              <option value="3" @if(in_array(3,explode(',',$item->type))) selected @else @endif>Employee</option>
                                                        </select>
                                                          @if ($errors->has('type'))
                                                              <span class="help-block">
