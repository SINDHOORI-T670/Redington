        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-toggle="modal" data-target="#createjournalModal"  href="#" class="btn btn-success mr-1 mb-1 ladda-button" data-style="expand-left"><i class="ft-plus white"></i> <span class="ladda-label">Add Value Journals</span></a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning text-white tab-order" href="{{url('admin/value_journals/list')}}/{{$item->id}}"><i class="icon-list"></i> Sub List</a>
                                            <button @if($item->status==0) class="btn btn-success text-white tab-order" @else class="btn btn-danger text-white tab-order" @endif onclick="confirmDelete('resource-active-{{ $item->id }}','{{ $item->journal }}','{{ $item->status }}');"> @if($item->status==0) <i class="fa fa-thumbs-o-up"></i> Active @else <i class="fa fa-thumbs-o-down"></i> Inactive @endif</button>
                                    ...
                                    <div class="modal fade text-left show" id="editJournalModal{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{url('admin/edit/journal')}}/{{$item->id}}" enctype="multipart/form-data">
                                                @csrf
                    ...
                    <div class="modal fade text-left show" id="createjournalModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form method="POST" action="{{url('admin/add/journal')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <fieldset class="form-group floating-label-form-group">
                                    ...
                                    <fieldset class="form-group floating-label-form-group">
                                        <label for="email" class="label-control">Description</label>
                                        <textarea cols="30" rows="15" class="form-control detail1" id="detail1" name="detail1" placeholder="Details about journal"></textarea>
                                          @if ($errors->has('detail1'))
                                              <span class="help-block">
                                                  <strong class="error">{{ $errors->first('detail1') }}</strong>
                                              </span>
