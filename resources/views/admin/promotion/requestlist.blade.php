                                            ...
                                            <form method="post" action="{{url('admin/respond/request')}}/{{$request->id}}">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <fieldset class="input-group floating-label-form-group">
                                                        <label class="label-control col-md-4"><b>Promotion Name</b>:</label>
                                                        <input  type="text" class="form-control col-md-8" value="{{(isset($request->promotion))?$request->promotion->name:""}}">
                                                    </fieldset><br>
                                                    <fieldset class="input-group floating-label-form-group">
