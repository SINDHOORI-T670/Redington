                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-toggle="modal" data-target="#createvaluestoriesModal"  href="#" class="btn btn-success mr-1 mb-1 ladda-button" data-style="expand-left"><i class="ft-plus white"></i> <span class="ladda-label">Add Value Stories</span></a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning text-white tab-order" href="{{url('admin/value_stories/list')}}/{{$item->id}}"><i class="icon-list"></i> Sub List</a>
                                            ...
                                            <form id="resource-active-{{ $item->id }}" action="{{url('admin/active/main_stories')}}/{{$item->id}}" method="get">
                                                {{ csrf_field() }}
                                            </form>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <h3 class="modal-title" id="myModalLabel35"> Edit Value Stories</h3>
                                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                              </button>
                                            </div>
                                            <form method="POST" action="{{url('admin/edit/main_value_stories')}}/{{$item->id}}" enctype="multipart/form-data">
                                                @csrf
                                              <div class="modal-body">
                                                ...
                                                <fieldset class="form-group floating-label-form-group">
                                                    <img class="card-img-top img-fluid" src="@if($item->image){{$item->image}} @else {{asset('admin/app-assets/images/portrait/small/avatar-s-1.png')}} @endif" alt="{{$item->title}}">
                    ...
                    <div class="modal fade text-left show" id="createvaluestoriesModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" style="padding-right: 17px;">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form method="POST" action="{{url('admin/add/main_value_stories')}}" enctype="multipart/form-data">
                                @csrf
                              <div class="modal-body">
                                  <fieldset class="form-group floating-label-form-group">
                                      <label class="label-control required">Title</label>
