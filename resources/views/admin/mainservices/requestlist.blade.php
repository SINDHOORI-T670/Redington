            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><a href="{{url('admin/subservices/list')}}/{{$sub->main_id}}"><i class="fa fa-arrow-left"></i></a> &nbsp;&nbsp;Requests</h4>
                                        ...
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <form method="post" action="{{url('admin/respond/request')}}/{{$request->id}}">
                                                @csrf
                                                <input type="hidden" name="type" value="Sub_service">
                                                <div class="modal-body">
                                                    ...
                                                    <fieldset class="input-group floating-label-form-group">
                                                        <label class="label-control col-md-4"><b>Service Name</b>:</label>
                                                        <input  type="text" class="form-control col-md-8" value="{{(isset($request->subservice))?$request->subservice->name:""}}">
                                                    </fieldset><br>
                                                    <fieldset class="input-group floating-label-form-group">
