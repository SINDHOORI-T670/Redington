                   ...
                   <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <ul class="list-inline">
                                <li ><a href="{{url('employee/sales_connect/meetingRequestfrompartner')}}" class="list-group-item active">Partner Meeting Requests</a></li>
                                <li ><a href="{{url('employee/sales_connect/meetingRequestfromcustomer')}}" class="list-group-item list-group-item-action">Customer Meeting Requests</a></li>
