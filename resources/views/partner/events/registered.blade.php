                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <ul class="list-inline">
                                <li class="pr-1"><a href="{{url('partner/list/new/events')}}" class="list-group-item list-group-item-action">New Events</a></li>
                                <li class="pr-1"><a href="{{url('partner/list/past/events')}}" class="list-group-item  list-group-item-action">Past Events</a></li>
                                <li class="pr-1"><a href="{{url('partner/list/event/registered')}}" class="list-group-item active">Applied Events</a></li>
                            </ul>
                                    ...
                                    @forelse($events as $event)
                                        ...
                                        @if(in_array(3,$array))
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a class="btn btn-info text-white tab-order" data-toggle="modal" data-target="#copyEventModal{{$event->id}}"  href="#" ><i class="icon-eye"></i></a>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <fieldset class="form-group floating-label-form-group">
                                                            ...
                                                            <fieldset class="form-group floating-label-form-group">
                                                                ...
                                                                <input type="date" class="form-control" id="date" name="date" min="<?php echo date("Y-m-d"); ?>" value="<?php echo date('Y-m-d',strtotime($event->date_time)) ?>" >
                                                                @if ($errors->has('date'))
                                                                    <span class="help-block">
