                                                                ...
                                                                @if(isset($item->subfiles))
                                                                    {{-- @forelse(explode(',',$item->file) as $index => $file)--}}
                                                                     @forelse($item->subfiles as $index => $file)
                                                                        ...
                                                                        @endphp 
                                                                        <li>
                                                                            <a  class="text-white" href="{{url('admin/downloadfile')}}/{{$file->file}}" title="File{{$index+1}}" download>File{{$index+1}} <i class="fa fa-file-{{$icons[$type]}}-o fa-1x text-center"/></i>&nbsp;&nbsp;</a> 
                                                                        </li>
                                                                    @empty 
                                                                    @endforelse
                                                                @endif
